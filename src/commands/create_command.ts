...
export class CreateCommand {
     ...
     */
    static async execute(projectName: string, options: CreateOptions, templatePath: string) {
        const answers = await inquirer.prompt([
            ...
            },
            {
                ...
                choices: [
                    { name: `default (${REGISTRY_URLS.default})`, value: REGISTRY_URLS.default },
                    { name: `taobao (${REGISTRY_URLS.taobao})`, value: REGISTRY_URLS.taobao },
                    { name: `tsinghua (${REGISTRY_URLS.tsinghua})`, value: REGISTRY_URLS.tsinghua },
                ],
        ...
        if (finalOptions.npm_type === "pnpm") {
            Logger.info("Node.js 18+ is recommended for pnpm.");
        }
